            ...
            <div className="footer">
                <div style={{borderBottom: '1px solid lightgray'}} className='grid'>
                    <div className="about-info">
                        ...
                        <div className="info">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur nesciunt voluptatem aperiam, veritatis ea voluptatum repellat, perferendis officiis rem dignissimos quis quidem sed minus nam officia maiores possimus corporis quos?
                        </div>
                    ...
                    <div className="quick-links">
                        <h3 className="txt" style={{fontFamily: "Kaushan Script"}}>
                            QUICK LINKS
                        </h3>
                    ...
                    <div className="user-service">
                        <h3 style={{fontFamily: "Kaushan Script"}} className="txt">
                            USER SERVICE
                        </h3>

                        <a href="">Climate Change Education</a>
                ...
                <div className="base">
                    <div id='copy'>
                        &copy; 2025  GoGreen - Make The Difference. All rights reserved.
                    </div>
